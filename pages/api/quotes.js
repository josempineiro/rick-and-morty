...
const quotes = [
  ...
  {
    quote: "If I die in a cage, I lose a bet.",
  ...
  {
    quote: "It's funny to say they are small. It's funny to say they are big.",
  ...
  {
    quote:
      "God's turning people into insect monsters, Beth. I'm the one beating them to death. Thank me.",
  ...
  {
    quote:
      "I realize now I'm attracted to you for the same reason I can't be with you; you can't change. And I have no problem with that, but it clearly means I have a problem with myself.",
    character: {
      id: "372",
      name: "Unity",
  ...
  {
    quote: "Ooh yeah, shame me. At least when I'm disgusting, it's on purpose.",
